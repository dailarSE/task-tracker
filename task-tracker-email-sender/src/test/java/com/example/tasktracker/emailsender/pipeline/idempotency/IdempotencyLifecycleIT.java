...
class IdempotencyLifecycleIT {
    ...
    void shouldMaintainKeyConsistencyAcrossLifecycle() {
        ...
        assertTrue(item.isPending(), "Guard should allow processing for the first time");
        ...
        item.markAsSent(); // Переводим в терминальный статус успеха
        ...
        assertEquals(PipelineItem.Status.SKIPPED, duplicateItem.getStatus(),
